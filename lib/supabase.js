...
export const ETIQUETAS_TICKET = [
  { tag: 'Urgente', color: '#ef4444' },
  { tag: 'Garantía', color: '#3b82f6' },
  { tag: 'Sin pago', color: '#f97316' },
  { tag: 'Esperando repuesto', color: '#f59e0b' },
  { tag: 'Cliente avisado', color: '#06b6d4' },
  { tag: 'Presupuesto enviado', color: '#22c55e' },
];

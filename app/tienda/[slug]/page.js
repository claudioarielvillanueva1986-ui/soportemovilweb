    ...
    <div className="tv1" style={{ '--accent': accent }}>
      ...
      <nav className="tv1-nav">
        <a href="#inicio" className="nav-brand">
          <div className="nav-logo"><b style={{ color: '#0A1220', fontWeight: 900 }}>{(neg.nombre || 'SM').slice(0, 1)}</b></div>
          <div className="nav-name">{nombrePartes[0]} <span>{nombrePartes.slice(1).join(' ')}</span></div>
        </a>
